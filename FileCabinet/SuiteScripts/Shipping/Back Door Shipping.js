...
define(['N/log', 'N/record', 'N/search', 'N/ui/serverWidget', 'N/url'],
    ...
    function(log, record, search, ui, url) {
        ...
        function onRequest(context) {
            ...
            try {
                context.response.writePage({
                    pageObject: renderForm("Back Door Shipping")
                });
            }
            catch(error){
        ...
        function renderForm(title){
            ...
            var allBackOrders = renderList(form, createSearch('customsearch_bd_orders_to_ship'), "All Pending Orders");
            var scBackOrders = renderList(form, createSearch('customsearch_no_sc_bd_ship_ready'), "Orders__Some Items Committed");
            var noScBackOrders = renderList(form, createSearch('customsearch_sc_bd_ship_ready'), "Ship Complete Orders__Fully Committed");
